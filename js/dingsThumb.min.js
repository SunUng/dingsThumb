...
f-l:f/2-l/2;return a}();a.css({top:c[1],left:c[0]})}function u(){a('<img class="image-adjusted" alt="'+k+'" class="'+l+'">').attr("src",q).load(function(){a(this).appendTo(m).siblings("img").remove();e()})}function v(){a('<img class="image-adjusted" alt="'+k+'" style="display:none;" class="'+l+'">').attr("src",q).load(function(){a(this).appendTo(m).fadeIn("slow").siblings("img").remove();e()})}var h=!1,b=a.extend({},a.fn.dingsThumb.defaults,r),d=a(this),f=d.height(),g=d.width(),t=b.cover,w=b.loading,
